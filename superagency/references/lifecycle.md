...
| Thought | Reality |
|---|---|
| "Send the re-engagement email to everyone inactive." | Segment by behaviour. Identical messaging to different situations is what makes lifecycle email feel like spam. |
| "They are on month twelve so they are established." | Tenure is not engagement. A dormant twelve-month user needs different handling than an active one. |
| "Now is a good time to pitch the upgrade." | Only after evidence of value. Expansion asks that precede it read as extraction. |
