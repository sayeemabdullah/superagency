...
## Measurement
Per creator, not in aggregate: unique codes or UTMs per creator, engagement quality (saves, comments, DMs — not just likes), and conversions attributed to their link. Compare cost-per-engagement and cost-per-acquisition across creators; one usually drives most of the result. Judge after the full content run, not the first post.
